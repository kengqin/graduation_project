    ...
    if (token) {
        getData("http://47.102.45.80:8080/api/user/checkToken/", null,{"token": token}, function (res) {
            if (res && res["status_code"] === "10003") {
                ...
                var a=[];
                // console.log(user_id)
                postData(api+'sceipe/get_self',{"user_id":user_id},null,function(res){
                    console.log(res.list)
                    if(res && res.status_code == '10016'){
                        // console.log(res.list)
                        a=res.list;
                        if(a.length<=5){
                    ...
                    <div class="btns">
                        ...
                        for(let b of btns){
                            b.onclick=function () {
                                ...
                                postData(api+'my_collection/delete_counteron',{"user_id": user_id,"recipe_id":b1},null,function(res){
