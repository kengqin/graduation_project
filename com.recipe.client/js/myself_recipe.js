    ...
    if (token) {
        getData("http://47.102.45.80:8080/api/user/checkToken/", null,{"token": token}, function (res) {
            if (res && res["status_code"] === "10003") {
                ...
                var a=[];
                // console.log(user_id)
                postData(api+'user/select_recipes',{"user_id":user_id},null,function(res){
                    ...
                    if(res && res.status_code == '10004'){
                        ...
                        for(var r of res.list.slice(0,5)){
                            lists.innerHTML +=`<div class="b-middles" id="${r['id']}">
                    ...
                    <div class="btns">
                        ...
                        for(let b of btns){
                            b.onclick=function () {
                                ...
                                postData(api+'user/delete_recipes',{"recipe_id":b1},null,function(res){
                                    if(res && res.status_code=='10004'){
